...
class MessagesFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'content' => ['type' => 'text', 'length' => 4294967295, 'null' => false, 'default' => null, 'collate' => 'utf8mb4_general_ci', 'comment' => '', 'precision' => null],
    ...
    public function init(): void
    {
        $this->records = [
            [
                ...
                'created_at' => 1596646022,
                'updated_at' => 1596646022,
            ],
        ];
        parent::init();
    }
